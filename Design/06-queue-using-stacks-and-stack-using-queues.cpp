...
public:
    ...
    int pop() {
        if (empty()) throw runtime_error("[QueueUsingStacks Error] Queue is empty!");
        shiftStacks();
    ...
    int size() const { return inStack.size() + outStack.size(); }
};
...
public:
    ...
    // Pop: O(1)
    int pop() {
        if (q1.empty()) throw runtime_error("[StackUsingTwoQueues Error] Stack is empty!");
        int topVal = q1.front();
        q1.pop();
        return topVal;
    }
...
public:
    ...
    // Pop: O(1)
    int pop() {
        if (q.empty()) throw runtime_error("[StackUsingSingleQueue Error] Stack is empty!");
        int topVal = q.front();
        q.pop();
        return topVal;
    }
...
// ============================================================================
int main() {
    cout << "========================================\n  1. TESTING QUEUE USING TWO STACKS\n========================================\n";
    ...
    myQueue.push(40);
    cout << "Pushed 40\n";
    while (!myQueue.empty()) cout << "Popped: " << myQueue.pop() << " ";
    cout << "\n";

    cout << "\n========================================\n  2. TESTING STACK USING TWO QUEUES\n========================================\n";
    StackUsingTwoQueues s2q;
    s2q.push(1); s2q.push(2); s2q.push(3);
    cout << "Pushed 1, 2, 3\n";
    cout << "Top element: " << s2q.top() << " (Expected: 3)\n";
    cout << "Popped: " << s2q.pop() << " (Expected: 3)\n";
    cout << "New Top: " << s2q.top() << " (Expected: 2)\n";

    cout << "\n========================================\n  3. TESTING STACK USING SINGLE QUEUE\n========================================\n";
    StackUsingSingleQueue s1q;
    s1q.push(100); s1q.push(200); s1q.push(300);
