...
> **When the interviewer asks:** *"What is REST and why/when do we use it?"*
>
> **You say:** *"REST is a stateless architectural style for web APIs that models data as resources identified by standard URLs. It uses standard HTTP verbs like GET, POST, PUT, and DELETE for CRUD operations and returns standard HTTP status codes, ensuring predictable caching and loose coupling between client and server."*
