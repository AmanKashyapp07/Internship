...
> **When the interviewer asks:** *"What is GIT and why/when do we use it?"*
>
> **You say:** *"Git is a distributed version control system where every clone contains the full history of the project as a Directed Acyclic Graph (DAG) of immutable commit objects. It tracks project snapshots through blobs and trees, enabling fast branching, 3-way merges, interactive rebasing, and emergency recovery via the reflog."*
