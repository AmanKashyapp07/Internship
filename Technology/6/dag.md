...
> **When the interviewer asks:** *"What is DAG and why/when do we use it?"*
>
> **You say:** *"A DAG Pipeline Scheduler models workflow tasks as directed acyclic graphs where edges represent dependencies. It uses Kahn's topological sort algorithm to identify and run all zero-dependency tasks in parallel, while using 3-color DFS to detect and prevent circular deadlock dependencies."*

---

## 1. What It Is in Plain English

In a complex CI/CD system (like GitHub Actions, GitLab CI, or CI/CD Pipeline Engines), pipelines are rarely simple linear scripts. For example:
...
## 4. Kahn's Algorithm (BFS) vs. DFS Topological Sort
...
## 5. Algorithmic Implementation: Kahn's Scheduling Engine
