 ...
 * CSES Problem Set
 * 
 * Problem: Maximum XOR Subsequence
 * Link: https://cses.fi/
 * Category: Mathematics
 * 
 * Description:
 * Find the maximum XOR sum of a subset of numbers.
 * 
 * Logic/Approach:
 * Construct linear basis of vector space using Gaussian elimination. Greedily maximize XOR value.
 */
