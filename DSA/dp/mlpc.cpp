 ...
 * lefti < righti. A pair p2 = [c, d] follows a pair p1 = [a, b] if b < c. A
 * chain of pairs can be formed in this fashion. Return the longest length of a
 * chain that can be formed.
 *
 * Approach:
 ...
 * - Iterate through sorted pairs and pick a pair if its start point is greater
 * than the end point of the last chosen pair in the chain.
 *
